...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?=SERVER_URL?>style/bootstrap-grid.min.css">
    <link rel="stylesheet" type="text/css" href="<?=SERVER_URL?>style/swiper-bundle.min.css">
...
<body>
    ...
    <script type="text/javascript" src="<?=SERVER_URL?>js/jquery.min.js"></script>
