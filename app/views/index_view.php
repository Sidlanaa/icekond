                                ...
                                <div class="check-form d-flex align-center">
                                    ...
                                    <div class="check-form-two-inner">
                                        <div class="square-calc d-flex align-center">
                                            <p>ПЛОЩА:</p>
                                            <input type="number" min="0" max="100" id="rangevalue" value="0"
                                                oninput="range.value=value" class="square-input two-block-input">
                                            <p>м&sup2</p>
                                        </div>
...
<section id="order-section" class="order-section container">
    <div class="order-type d-flex justify-center">
        ...
        <a href="#" class=" <?= $item->name == "Кондиціонер" ? 'air-conditioner' : 'recuperator'?> conditioner type <?= $index  == 0 ? 'active' : ''?>">
            <?=$item->name?>
        </a>
        <?php } } ?>
    </div>
    <div class="air-conditioners">
        ...
        <!-- <div id="cond-4" class="sale-line cond">
            <div class="order-position-block sale-block">
                <div class="set-type">
        ...
        <div id="cond-5" class="sale-line cond">
            <div class="order-position-block sale-block">
                <div class="set-type">
                    <h4>Пакет <span>VIP</span></h4>
                </div>
