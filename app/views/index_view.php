<section class="main-section">
	...
	<div class="main-section-into d-flex container">
		<div class="main-sale-mob-form">
			...
			<form action="" class="main-mobile-form">
					...
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide">
							<div class="check-form-four check-form-block">
								<div class="">
									<h5>Для отримання розрахунку та <span class="green-bold-text">знижки 50%</span> на монтаж залиште свої дані і ми зв’яжемося з Вами</h5>
									<div class="common-form">
										<label for="name-order-calculation flex">
											<img src="style/images/name.svg" alt="name">
											<input id="name-order-calculation" type="text" required
												placeholder="Ваше ім’я">
										</label>
										<label for="tel-order-calculation flex">
											<img src="style/images/tel.svg" alt="tel">
											<input id="tel-order-calculation" type="tel" required
	...
	<div class="calculation-call-block container flex align-center">
		...
		<div class="calculation-call-form">
			...
			<form action="" class="common-form">
				<label for="name-order-calculation flex">
					<img src="style/images/name.svg" alt="name">
					<input id="name-order-calculation" type="text" required placeholder="Ваше ім’я">
				</label>
				<label for="tel-order-calculation flex">
					<img src="style/images/tel.svg" alt="tel">
					<input id="tel-order-calculation" type="tel" required placeholder="Ваш телефон">
	...
	<div class="sale-line">
		<div class="hit-sale-position sale-block">
			<div class="sales-marks">
				<p class="sale-sale"><span>акція</span></p>
				<p class="percent-minus"><span>-50%</span> на монтаж</p>
				<p class="super-price">Супер ціна</p>
				<p class="top-sale">Топ продаж</p>
			</div>
			<div class="sale-bank">
				<img src="style/images/paw.png" class="mono-parts" alt="mono-parts">
				<img src="style/images/parts.png" class="privat-parts" alt="privat-parts">
			</div>
			<div class="sale-img">
				<img src="images/tovar.png" alt="tover">
			</div>
			<h5 class="sale-item">Cooper&Hunter Prima Plus CH-S07XN7</h5>
			<p class="sale-description">режим для сну SLEEP – ще менше шуму;<br>інтенсивне охолодження або
				нагрівання повітря в режимі Turbo;<br>повне очищення від алергенів та бактерій;<br>можливість
				повернутися до заводських налаштувань одним кліком;</p>
			<div class="price">
				<span class="old-price">7900 грн</span>
				<span class="current-price">6999 грн</span>
			</div>
			<form action="" class="common-form">
				<label for="tel-order-calculation flex">
					<img src="style/images/tel.svg" alt="tel">
		...
		<div class="hit-sale-position sale-block">
			...
			<div class="sale-img">
				<img src="images/tovar.png" alt="tovar">
			</div>
			<h5 class="sale-item">Cooper&Hunter Prima Plus CH-S07XN7</h5>
			<p class="sale-description">режим для сну SLEEP – ще менше шуму;<br>інтенсивне охолодження або
				нагрівання повітря в режимі Turbo;<br>повне очищення від алергенів та бактерій;<br>можливість
		...
		<div class="hit-sale-position sale-block">
			...
			<h5 class="sale-item">Cooper&Hunter Prima Plus CH-S07XN7</h5>
			<p class="sale-description">повне очищення від алергенів та бактерій;<br>можливість повернутися до
				заводських налаштувань одним кліком;</p>
			<div class="price">
				<span class="current-price">6999 грн</span>
			</div>
			<form action="" class="common-form">
